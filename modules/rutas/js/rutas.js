function editarRuta(id){
  ...
  var ruta = 'ruta_editar.php?id='+id;
...
function buscar_institucion(municipio,tipo){
  ...
  var datos = {"municipio":municipio,"tipo":tipo};
    $.ajax({
      type: "POST",
      url: "fn_despacho_buscar_institucion.php",
      data: datos,
      beforeSend: function(){
        $('#loader').fadeIn();
      },
...
function buscar_sede(semana, municipio, tipo, institucion){
  var datos = {"semana":semana,"municipio":municipio,"tipo":tipo,"institucion":institucion};
    $.ajax({
      type: "POST",
      url: "fn_despacho_buscar_sede.php",
      data: datos,
      beforeSend: function(){
        $('#loader').fadeIn();
      },
...
function despachos_kardex(){
  ...
  if(bandera == 0){
    ...
    $('#formDespachos').attr('action', 'despacho_kardex.php');
...
function editar_despacho(){
  ...
  if(bandera == 0){
    ...
    if (r == true) {
      ...
      var datos = {"despacho":despacho};
      $.ajax({
        type: "POST",
        url: "fn_despacho_eliminar.php",
        data: datos,
        beforeSend: function(){
          $('#loader').fadeIn();
        },
...
$(document).ready( function () {
  dataset1 = $('#box-table-movimientos').dataTable({
    ...
    "oLanguage": {
        "sLengthMenu": "Display _MENU_ registros por p�gina",
