...
$actualizar = "UPDATE menu_valref_nutrientes SET kcalxg = '".$kcalxg."', kcaldgrasa = '".$kcaldgrasa."', Grasa_Sat = '".$Grasa_Sat."', Grasa_poliins = '".$Grasa_poliins."', Grasa_Monoins = '".$Grasa_Monoins."', Grasa_Trans = '".$Grasa_Trans."', Fibra_dietaria = '".$Fibra_dietaria."', Azucares = '".$Azucares."', Proteinas = '".$Proteinas."', Colesterol = '".$Colesterol."', Sodio = '".$Sodio."', Zinc = '".$Zinc."', Calcio = '".$Calcio."', Hierro = '".$Hierro."', Vit_A = '".$Vit_A."', Vit_C = '".$Vit_C."', Vit_B1 = '".$Vit_B1."', Vit_B2 = '".$Vit_B2."', Vit_B3 = '".$Vit_B3."', Acido_Fol = '".$Acido_Fol."' WHERE id = '".$idvalref."' ";

if ($Link->query($actualizar)===true) {
	$sqlBitacora = "INSERT INTO bitacora (id, fecha, usuario, tipo_accion, observacion) VALUES ('', '".date('Y-m-d H:i:s')."', '".$_SESSION['idUsuario']."', '57', 'Actualizó los datos de los aportes calóricos y nutricionales para el complemento <strong>".$complemento."</strong> y grupo Etario <strong>".$nomGETA."</strong> ')";
