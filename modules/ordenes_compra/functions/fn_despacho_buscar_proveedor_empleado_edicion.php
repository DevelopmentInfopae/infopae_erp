...
if(isset($_POST['proveedorEmpleado'])){
  $proveedorEmpleado = $_POST['proveedorEmpleado'];
}
...
if($subtipo == 11 || $subtipo == 12){
  ...
  if($resultado->num_rows >= 1){
  	while($row = $resultado->fetch_assoc()){
  			...
  			$nombre = $row['nombre'];
        if($proveedorEmpleado == $documento){
echo "<option value='$documento' selected >$nombre</option>";
        }
          else{
