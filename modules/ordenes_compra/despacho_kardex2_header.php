<?php
 //header
  ...
  $pdf->Cell(17.471,5,'TOTAL',0,5,'C',False);
  $pdf->SetXY($current_x+17.471, $current_y);

  $current_y = $pdf->GetY();
  $current_x = $pdf->GetX();
  $pdf->Cell(39,15,'',1,0,'L',False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(39,8,utf8_decode('LUNES'),'B',8,'C',False);
  $pdf->Cell(13,7,'CANT','R',0,'C',False);
  $pdf->Cell(13,7,'SALIDA','R',0,'C',False);
  $pdf->Cell(13,7,'SALDO','R',0,'C',False);
  $pdf->SetXY($current_x+39, $current_y);

  $current_y = $pdf->GetY();
  $current_x = $pdf->GetX();
  $pdf->Cell(39,15,'',1,0,'L',False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(39,8,utf8_decode('MARTES'),'B',8,'C',False);
  $pdf->Cell(13,7,'CANT','R',0,'C',False);
  $pdf->Cell(13,7,'SALIDA','R',0,'C',False);
  $pdf->Cell(13,7,'SALDO','R',0,'C',False);
  $pdf->SetXY($current_x+39, $current_y);
  ...
  $pdf->Cell(39,15,'',1,0,'L',False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(39,8,utf8_decode('MIERCOLES'),'B',8,'C',False);
  $pdf->Cell(13,7,'CANT','R',0,'C',False);
  $pdf->Cell(13,7,'SALIDA','R',0,'C',False);
  $pdf->Cell(13,7,'SALDO','R',0,'C',False);
  $pdf->SetXY($current_x+39, $current_y);
  ...
  $pdf->Cell(39,15,'',1,0,'L',False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(39,8,utf8_decode('JUEVES'),'B',8,'C',False);
  $pdf->Cell(13,7,'CANT','R',0,'C',False);
  $pdf->Cell(13,7,'SALIDA','R',0,'C',False);
  $pdf->Cell(13,7,'SALDO','R',0,'C',False);
  $pdf->SetXY($current_x+39, $current_y);
  ...
  $pdf->Cell(39,15,'',1,0,'L',False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(39,8,utf8_decode('VIERNES'),'B',8,'C',False);
  $pdf->Cell(13,7,'CANT','R',0,'C',False);
  $pdf->Cell(13,7,'SALIDA','R',0,'C',False);
  $pdf->Cell(13,7,'SALDO','R',0,'C',False);
  $pdf->SetXY($current_x+39, $current_y);
