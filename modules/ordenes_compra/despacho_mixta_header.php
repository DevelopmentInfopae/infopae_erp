...
//header
  ...
  $pdf->Cell(0,4.3,utf8_decode('REMISIÓN ENTREGA DE VÍVERES EN INSTITUCIÓN EDUCATIVA'),0,4.3,'C',False);
  ...
  $pdf->Cell(23.788,15,'GRUPO ALIMENTO',1,0,'C',False);
  ...
  $current_y = $pdf->GetY();
  $current_x = $pdf->GetX();
  $pdf->Cell(20.6,15,'',1,0,'L',False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(20.6,4,'CANTIDAD',0,4,'C',False);
  $pdf->Cell(20.6,4,'ENTREGADA','B',4,'C',False);
  $pdf->Cell(10.6,7,'TOTAL','R',0,'C',False);
  $pdf->Cell(5,7,'C','R',0,'C',False);
  $pdf->Cell(5,7,'NC','R',0,'C',False);
  $pdf->SetXY($current_x+20.6, $current_y);
  ...
  $current_y = $pdf->GetY();
  $current_x = $pdf->GetX();
  $pdf->Cell(32,15,'',1,0,'L',False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(32,8,utf8_decode('LUNES'),'B',8,'C',False);
  $pdf->Cell(12,7,'SALIDA','R',0,'C',False);
  $pdf->Cell(12,7,'SALDO','R',0,'C',False);
  $pdf->Cell(8,7,'OK','R',0,'C',False);
  $pdf->SetXY($current_x+32, $current_y);

  $current_y = $pdf->GetY();
  $current_x = $pdf->GetX();
  $pdf->Cell(32,15,'',1,0,'L',False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(32,8,utf8_decode('MARTES'),'B',8,'C',False);
  $pdf->Cell(12,7,'SALIDA','R',0,'C',False);
  $pdf->Cell(12,7,'SALDO','R',0,'C',False);
  $pdf->Cell(8,7,'OK','R',0,'C',False);
  $pdf->SetXY($current_x+32, $current_y);
  ...
  $pdf->Cell(32,15,'',1,0,'L',False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(32,8,utf8_decode('MIERCOLES'),'B',8,'C',False);
  $pdf->Cell(12,7,'SALIDA','R',0,'C',False);
  $pdf->Cell(12,7,'SALDO','R',0,'C',False);
  $pdf->Cell(8,7,'OK','R',0,'C',False);
  $pdf->SetXY($current_x+32, $current_y);
  ...
  $pdf->Cell(32,15,'',1,0,'L',False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(32,8,utf8_decode('JUEVES'),'B',8,'C',False);
  $pdf->Cell(12,7,'SALIDA','R',0,'C',False);
  $pdf->Cell(12,7,'SALDO','R',0,'C',False);
  $pdf->Cell(8,7,'OK','R',0,'C',False);
  $pdf->SetXY($current_x+32, $current_y);
  ...
  $pdf->Cell(32,15,'',1,0,'L',False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(32,8,utf8_decode('VIERNES'),'B',8,'C',False);
  $pdf->Cell(12,7,'SALIDA','R',0,'C',False);
  $pdf->Cell(12,7,'SALDO','R',0,'C',False);
  $pdf->Cell(8,7,'OK','R',0,'C',False);
  $pdf->SetXY($current_x+32, $current_y);
...
//$pdf->Cell(20,7,$pdf->GetX(),0,0,'L',False);
