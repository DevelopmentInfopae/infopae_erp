...
<div class="row wrapper wrapper-content border-bottom white-bg page-heading">
  <div class="col-lg-8">
    ...
    <ol class="breadcrumb">
      ...
      <li>
        <a href="ver_alimentos.php">Ver alimentos</a>
      </li>
      <li class="active">
  ...
  <div class="col-lg-4">
    <div class="title-action">
      <button class="btn btn-primary" onclick="submitForm('formCalyNut');" id="segundoBtnSubmit" style="display: none;"><span class="fa fa-check"></span> Guardar</button>
    </div><!-- /.title-action -->
  </div><!-- /.col -->
</div><!-- /.row -->
          ...
          <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true"><!-- COLLAPSE -->
            <div class="panel panel-default">
              <div class="panel-heading clearfix" role="tab" id="headingOne"> 
                <h4 class="panel-title"><span class="fa fa-file-text-o"></span>   Datos del alimento / alimento para ración industrializada
                  ...
                  <form class="form" id="formProducto" method="post">
                    <div class="form-group col-sm-3">
                      ...
                      <select class="form-control" name="tipoProducto" id="tipoProducto" required>
                        <option value="03">Alimento</option>
                        <option value="04">Alimento para ración industrializada</option>
                      </select>
                    </div>
            ...
            <div class="panel panel-default" id="fichaTecnicaPanel" style="display: none;">
            ...
            <div class="panel panel-default" id="aportesCalyNutPanel">
              <div class="panel-heading" role="tab" id="headingThree">
                <h4 class="panel-title"><span class="fa fa-bar-chart-o"></span> Valores calóricos y nutricionales
