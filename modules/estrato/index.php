<?php
  ...
  <?php exit(); }
        ...
        ?><script type="text/javascript">
          ...
          const list2 = document.querySelector(".li_estrato");
  ...
  $titulo = 'Estrato';
  $nameLabel = get_titles('configuracion', 'estrato', $labels);
  $titulo = $nameLabel;
?>
...
<script>
  ...
  $('#box-table').DataTable({
    buttons: [ {extend: 'excel', title: 'Estrato', className: 'btnExportarExcel', exportOptions: { columns: [ 0, 1] } } ],
