...
$y = $pdf->GetY();
$pdf->SetXY($x, $y-1.6);
if ( $tipoPlanilla == 6 || $tipoPlanilla == 7 || $tipoPlanilla == 8) { $anchoDatosNombre = 29.9; } else { $anchoDatosNombre = 26.5; }
...
$y = $pdf->GetY();
$pdf->SetXY($x, $y-1.6);
$pdf->Cell(22,14,utf8_decode('Fecha Nacimiento'),0,0,'C',False);
$pdf->SetXY($x, $y+1.6);
$pdf->Cell(22,14,utf8_decode('DD/MM/AAAA'),0,0,'C',False);
$pdf->SetXY($x, $y);
$pdf->Cell(22,14,utf8_decode(''),'R',0,'C',False);
$x = $pdf->GetX();
$y = $pdf->GetY();
...
$y = $pdf->GetY();
$pdf->SetXY($x, $y-1.6);
$pdf->Cell(16,14,utf8_decode('Pertenencia'),0,0,'C',False);
$pdf->SetXY($x, $y+1.6);
$pdf->Cell(16,14,utf8_decode('Étnica'),0,0,'C',False);
$pdf->SetXY($x, $y);
$pdf->Cell(16,14,utf8_decode(''),'R',0,'C',False);
$x = $pdf->GetX();
$y = $pdf->GetY();
