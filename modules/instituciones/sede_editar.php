          ...
          <form id="formActualizarSede" action="" method="post">
          	<div class="row">
                  ...
                  <div class="form-group col-sm-3">
		                ...
		                <input type="text" class="form-control" name="codigo" id="codigo" value="<?php echo $registrosSede["cod_sede"]; ?>" required>
		              ...
		              <div class="form-group col-sm-3">
		                ...
		                <input type="email" class="form-control" name="email" id="email" value="<?php echo $registrosSede["email"]; ?>">
		              </div>
		              ...
		              <div class="form-group col-lg-3">
			                ...
			                <div class="radio">
											  ...
											  <label>
											    <input type="radio" name="sector" id="sector2" value="0" required <?php if(isset($registrosSede["sector"]) && $registrosSede["sector"] == "0"){ echo "checked"; } ?>>
											    Urbano
											  </label>
											</div>
...
<script type="text/javascript">
	// Configuración de la validación de formulario.
