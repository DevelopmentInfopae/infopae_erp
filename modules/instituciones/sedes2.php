        ...
        { defaultContent:'<div class="btn-group">'+
                                      '<div class="dropdown pull-right">'+
                                        ...
                                        '<ul class="dropdown-menu pull-right" aria-labelledby="dropDownMenu1">'+
                                          '<li>'+
                                            '<a href="#" class="editarSede"><i class="fas fa-pencil-alt fa-lg"></i> Editar</a>'+
                                          '</li>'+
                                          '<li>'+
                                          ...
                                          '<li>'+
                                            '<a href="#">'+
                                              'Estado: &nbsp;'+
                                              '<input type="checkbox" id="InputEstadoSede" class="estadoSede" data-toggle="toggle" data-on="Activo" data-off="Inactivo" data-size="mini" data-width="70" data-height="24">'+
                                            '</a>'+
                                          '</li>'+
                                        '</ul>'+
                                      '</div>'+
