      ...
      <div class="ibox float-e-margins">
        <div class="ibox-content contentBackground">
        	...
        	<table class="table table-striped selectableRows" id="box-table">
        		...
        		<tbody>
        		<?php
              $consulta = "SELECT * FROM productos".date('y')." WHERE (Codigo like '03%' or Codigo like '04%') AND nivel = '3'";
...
<script type="text/javascript">
  ...
  dataset1 = $('#box-table').DataTable({
    ...
    buttons : [{extend:'excel', title:'Alimentos', className:'btnExportarExcel', exportOptions: {columns : [0,1,2,3,4,5]}}],
    oLanguage: {
