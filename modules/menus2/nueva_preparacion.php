...
<div class="row wrapper wrapper-content border-bottom white-bg page-heading">
  	<div class="col-lg-8">
    	...
    	<ol class="breadcrumb">
      		...
      		<li>
        		<a href="ver_preparaciones.php">Ver <?= $nameLabel ?></a>
      		</li>
      		<li class="active">
          			...
          			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true"><!-- COLLAPSE -->
            			<div class="panel panel-default">
              				<div class="panel-heading clearfix" role="tab" id="headingOne"> 
                				<h4 class="panel-title"><span class="fa fa-file-text-o"></span>   Datos de la preparación
                  					...
                  					<form class="form" id="formProducto" method="post">
                    					<div class="form-group col-sm-3">
                      						...
                      						<select class="form-control" name="tipoProducto" id="tipoProducto" required>
												<option value="02">Preparación</option>
											</select>
										</div>
            			...
            			<div class="panel panel-default" id="fichaTecnicaPanel">
              				<div class="panel-heading" role="tab" id="headingTwo">
                				<h4 class="panel-title"><span class="fa fa-list-alt"></span> Composición de la preparación
						...
						<div class="panel panel-default" id="aportesCalyNutPanel" style="display: none;">
							<div class="panel-heading" role="tab" id="headingThree">
								<h4 class="panel-title"><span class="fa fa-bar-chart-o"></span>  Valores calúricos.
