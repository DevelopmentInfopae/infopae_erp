      		...
      		<div class="ibox float-e-margins">
        		<div class="ibox-content contentBackground">
					<?php
						...
						// 2. Subproductos
						$consultaSubProductos =  "SELECT 	f.id as idFichaTecnica,
															fd.* 
														FROM fichatecnica f 
														LEFT JOIN fichatecnicadet fd ON f.Codigo = fd.codigo 
														WHERE fd.IdFT = '".$idProducto."' ";
						...
						$consultaCantidadesGrupo = "SELECT 	idft, 
															count(idFT) AS materias, 
															max(cantidad), 
															mac.grupo_alim 
														FROM fichatecnicadet fd 
														LEFT JOIN menu_aportes_calynut mac ON fd.codigo = mac.cod_prod 
														WHERE fd.idFT IN (
																			SELECT f.id 
																			FROM fichatecnica f 
																			LEFT JOIN fichatecnicadet fd ON f.Codigo = fd.codigo 
						...
						// 3. Materias primas
						$consultaMateriasPrimas = " SELECT fd.*, mac.* 
													FROM fichatecnicadet fd 
													LEFT JOIN menu_aportes_calynut mac ON fd.codigo = mac.cod_prod 
													WHERE fd.idFT IN (
																		SELECT f.id 
						...
						// Debemos ir a la tabla de productos$annoactual encontrar el grupo etario y poder traer estosdatos.
              								...
              								?>
              										<tr>
														...
														?>
                    													...
                    													<td style="text-align: center"> <!-- CALORÍAS (Kcal) las calorías se expresan en kcal/100 g de alimento. -->
                    													...
                    													<td style="text-align: center"> <!--  Kcal DESDE LA GRASA -->
																		...
																		<td style="text-align: center"><!--  PROTEÍNA (g) -->
																		...
																		<td style="text-align: center"> <!--  GRASA (g) -->
																		<?php
																		...
																		<td style="text-align: center"><!-- GRASA SATURADA (g) -->			
																		...
																		<td style="text-align: center"> <!--  GRASA POLIINSATURADA(g) -->
																		...
																		<td style="text-align: center"><!--  GRASA MONOINSATURADA(g) -->
																		...
																		<td style="text-align: center"> <!--  GRASA TRANS (g) -->
																		...
																		<td style="text-align: center"> <!-- CORBOHIDRATOS (g) -->
																		<?php
																		...
																		<td style="text-align: center"> <!-- Fibra dietaria -->
																		...
																		<td style="text-align: center"><!--  AZÚCARES (g) -->
																		...
																		<td style="text-align: center"> <!--  COLESTEROL -->
																		...
																		<td style="text-align: center"><!--  SODIO -->
																		...
																		<td style="text-align: center"><!--  ZINC -->
																		...
																		<td style="text-align: center"><!--  CALCIO -->
																		...
																		<td style="text-align: center"> <!--  HIERRO -->
																		...
																		<td style="text-align: center"> <!--  VIT A -->
																		...
																		<td style="text-align: center"><!--  VIT C -->
																		...
																		<td style="text-align: center"><!--  VIT B1 -->
																		...
																		<td style="text-align: center"> <!--  VIT B2 -->
																		...
																		<td style="text-align: center"><!--  VIT B3 -->
																		...
																		<td style="text-align: center"><!--  ÁCIDO FÓLICO -->
                  										...
                  										<?php 
															} //Termina el for de k donde se imprimen los ingredientes del sub producto 
														?>
                  							<?php 
												} //Termina el for de la i que recorre los sub productos del menu 
											?>
                							</tbody>
                							<tfoot>
                  								<tr>
              						...
              						<div class="table-responsive">
										<table class="tablaNutricional table table-striped table-bordered table-hover" style="text-align: center">
											<thead>
												...
												<tr> 
													<td><strong>Cantidad por porción</strong></td> <td style="text-align: center"><strong>g</strong></td> 
											...
											<tbody>
												...
												<tr>
                  								...
                  								<tr>
													<td colspan="3">*Los porcentajes de valores diarios están basados en una dieta de <?php echo $valoresMenu['kcalxg']; ?> calorías. Sus valores dietarios pueden ser mayores o menores dependiendo de sus necesidades calóricas</td>
												</tr>
                							</tbody>
              							</table>
                               		</div><!-- /.table-responsive -->
