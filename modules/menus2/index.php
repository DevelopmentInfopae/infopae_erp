        		...
        		<div class="ibox-content contentBackground">
          			<form class="form row" method="POST">
            			<div class="form-group col-sm-3">
              				<label for='ciclo_menus'>N° de Ciclo</label>
            			...
            			<div class="form-group col-sm-3">
              				<label for='complemento_menus'>Tipo de complemento</label>
        				...
        				<?php
              				...
              				if (isset($_POST['filtro_menus'])) {
                				...
                				if (isset($_POST['ciclo_menus']) && $_POST['ciclo_menus'] != "") {
                  					$condicion = " AND ID IN (";
									// exit(var_dump($_POST['ciclo_menus']));
                				...
                				$consulta = "SELECT * FROM productos".$_SESSION['periodoActual']." WHERE Codigo like '01%' AND nivel = '3' ".$condicion;
              				} else {
                				$consulta = "SELECT * FROM productos".$_SESSION['periodoActual']." WHERE Codigo like '01%' AND nivel = '3'";
              				}
                  		...
                  		?>
                  					...
                  					<tr idproducto="<?php echo $row1['Id']; ?>"  codigo="<?php echo $row1['Codigo']; ?>" descripcion="<?php echo $row1['Descripcion']; ?>">
                      					...
                      					<?php if ($row1['Inactivo'] == 0): ?> <td>Activo</td>
                      					<?php else: ?> <td>Inactivo</td>
                      					<?php endif ?>
                      					<td>
                        					<div class="btn-group">
                          						<div class="dropdown">
