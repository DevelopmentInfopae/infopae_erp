                ...
                <div class="ibox-content contentBackground">
                    <?php
                        ...
                        for ($k=0; $k < count($_POST) ; $k++) {
                            ...
                            $consulta = " SELECT    Etario1_$modalidad as grupo1, 
                                                    Etario2_$modalidad as grupo2, 
                                                    Etario3_$modalidad as grupo3,
                                                    Etario4_$modalidad as grupo4,
                                                    Etario5_$modalidad as grupo5
                            ...
                            for ($i=0; $i < count($alimentos) ; $i++) {
                                ...
                                $consulta = " SELECT DISTINCT p.codigo, 
                                                ...
                                                WHERE p.codigo = $auxCodigo AND p.TipodeProducto = 'Alimento'  ";
                                ...
                                if($resultado->num_rows >= 1){
                                    while($row = $resultado->fetch_assoc()){
                                        $alimento['componente'] = $row['Descripcion'];
                        ...
                        <form class="" action="" method="post" name="formulario1" id="formulario1">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr> 
                                            <th colspan="3" class="alineacionIzquierda"> MUNICIPIO </th>
                                            <th colspan="8" class="alineacionIzquierda sencilla"><?php echo $municipio; ?></th>
                                        </tr>
                                        <tr>
                                            <th colspan="3" class="alineacionIzquierda"> INSTITUCION </th>
                                            <th colspan="8" class="alineacionIzquierda sencilla"><?php echo $institucion; ?></th>
                                        </tr>       
                                        <tr> 
                                            <th colspan="3" class="alineacionIzquierda"> SEDE EDUCATIVA </th>
                                            <th colspan="8" class="alineacionIzquierda sencilla"><?php echo $sede; ?></th>
                                        </tr>
                                        <tr> 
                                            <th colspan="3" class="alineacionIzquierda"> N° BENEFICIARIOS </th> 
                                            <th colspan="8" class="alineacionIzquierda sencilla"> <?php echo $cobertura; ?> </th> 
                                        </tr>
                                        <tr> 
                                            <th colspan="3" class="alineacionIzquierda"> MODALIDAD </th> 
                                            <th colspan="8" class="alineacionIzquierda sencilla"> <?php echo $modalidad; ?> </th> 
                                        </tr>
                                        <tr> 
                                            <th colspan="3" class="alineacionIzquierda"> SEMANA N° </th> 
                                            <th colspan="8" class="alineacionIzquierda sencilla"> <?php echo $semana; ?> </th> 
                                        </tr>
                                        <tr> 
                                            <th colspan="3" class="alineacionIzquierda"> N° DIAS DESPACHO </th> 
                                            <th colspan="8" class="alineacionIzquierda sencilla"> X <?php echo $cantDias; ?> DIAS - <?php echo strtoupper($dias); ?></th> 
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th colspan="5"> GRUPO DE BENEFICIARIOS </th>
                                            <th class="text-center">PREESCOLAR </th>
                                            <th class="text-center">PRIMERO, SEGUNDO, TERCERO</th>
                                            <th class="text-center">CUARTO, QUINTO</th>
                                            <th class="text-center">SECUNDARIA</th>
                                            <th class="text-center">MEDIA</th>
                                            <th class="text-center"> TOTAL COBERTURA </th>
                                        </tr>
                                        <tr>
                                            <th colspan="5"> COBERTURA POR GRUPO </th>
                                            ...
                                            <th class="text-center"><?php echo $sedeGrupo4;?></th>
                                            <th class="text-center"><?php echo $sedeGrupo5;?></th>
                                            <th class="text-center"><?php echo ($sedeGrupo1 + $sedeGrupo2 + $sedeGrupo3 + $sedeGrupo4 + $sedeGrupo5); ?></th>
                                        </tr>
                                        <tr>
                                            <th class="text-center"> GRUPOS DE ALIMENTOS </th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                ?>
                                                <td> <?php echo $alimento['componente']; ?> </td>
                                                <td> <?php echo $alimento['presentacion']; ?> </td>
                                                <td> <?php echo 0+$alimento['cant_grupo1']; ?> </td>
                                                <td> <?php echo 0+$alimento['cant_grupo2']; ?> </td>
                                                <td> <?php echo 0+$alimento['cant_grupo3']; ?> </td>
                                                <td> <?php echo 0+$alimento['cant_grupo4']; ?> </td>
                                                <td> <?php echo 0+$alimento['cant_grupo5']; ?> </td>
                                                <td> <?php echo 0+$alimento['cant_total']; ?> </td>
                                                <td>
