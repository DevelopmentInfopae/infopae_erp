...
if ($cantGruposEtarios == '5') {
   ...
   $pdf->Cell(45, 4.7, utf8_decode($sedeGrupo1), 1, 4.7, 'C', False);
   $pdf->Cell(45, 4.7, utf8_decode($sedeGrupo2), 1, 4.7, 'C', False);
   $pdf->Cell(45, 4.7, utf8_decode($sedeGrupo3), 1, 4.7, 'C', False);
   $pdf->Cell(45, 4.7, utf8_decode($sedeGrupo4), 1, 4.7, 'C', False);
   $pdf->Cell(45, 4.7, utf8_decode($sedeGrupo5), 1, 0, 'C', False);
   $pdf->SetXY($current_x+45, $current_y);
   ...
   if($modalidad == 'APS'){
      $pdf->SetFont('Arial','',$tamannoFuente+7);
      $pdf->Cell(0,9.4,utf8_decode($jt),0,0,'C',False);
      $pdf->SetFont('Arial','',$tamannoFuente);
   }else{
      $pdf->Cell(7,4.7,'JM:',0,0,'L',False);
      $pdf->Cell(33,4.7,$jm,'B',0,'L',False);
