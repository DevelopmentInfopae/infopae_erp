...
if ($cantGruposEtarios == '5') {
   ...
   $pdf->Cell(45, 4.7, utf8_decode($totalGrupo1), 1, 4.7, 'C', False);
   $pdf->Cell(45, 4.7, utf8_decode($totalGrupo2), 1, 4.7, 'C', False);
   $pdf->Cell(45, 4.7, utf8_decode($totalGrupo3), 1, 4.7, 'C', False);
   $pdf->Cell(45, 4.7, utf8_decode($totalGrupo4), 1, 4.7, 'C', False);
   $pdf->Cell(45, 4.7, utf8_decode($totalGrupo5), 1, 0, 'C', False);
   $pdf->SetXY($current_x+45, $current_y);
