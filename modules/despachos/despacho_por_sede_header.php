...
/****************************************************************** manejo header cuando son 5 grupos etarios  ************************************************************/
if ($cantGruposEtarios == 5) {
  ...
  $pdf->Cell(36.7,4.7,utf8_decode($sedeGrupo1),1,4.7,'C',False);
  $pdf->Cell(36.7,4.7,utf8_decode($sedeGrupo2),1,4.7,'C',False);
  $pdf->Cell(36.7,4.7,utf8_decode($sedeGrupo3),1,4.7,'C',False);
  $pdf->Cell(36.7,4.7,utf8_decode($sedeGrupo4),1,4.7,'C',False);
  $pdf->Cell(36.7,4.7,utf8_decode($sedeGrupo5),1,0,'C',False);
  $pdf->SetXY($current_x+36.7, $current_y);
  ...
  $pdf->Cell(36.7,4.7,utf8_decode($sedeGrupo3),1,4.7,'C',False);
  $pdf->Cell(36.7,4.7,utf8_decode($sedeGrupo4),1,4.7,'C',False);
  $pdf->Cell(36.7,4.7,utf8_decode($sedeGrupo5),1,0,'C',False); // 23.5
  $pdf->SetXY($current_x+36.7, $current_y);
  ...
  $cantDias = count($cantDias);
  $auxDias = "X ".$cantDias." DIAS ".strtoupper($dias);
  $pdf->MultiCell(45,7,$auxDias,0,'C',False);
  $pdf->SetXY($current_x, $current_y+9.5);
  $pdf->MultiCell(45,7,'SEMANA: '.$semana,0,'C',False);
  ...
  $pdf->SetXY($current_x, $current_y+3);
  $pdf->Cell(57.8,7,'SEMANA: '.$ciclo,0,0,'C',False);
  $pdf->SetXY($current_x, $current_y+9.5);
  $pdf->Cell(57.8,7,'MENUS: '.$auxMenus,0,0,'C',False);
  $pdf->SetFont('Arial','',$tamannoFuente);
  ...
  $pdf->SetXY($current_x+2, $current_y+3);
  ...
  $pdf->Cell(7,7,'JM:',0,0,'L',False);
  $pdf->Cell(33,6,$jm,'B',0,'L',False);
  $pdf->SetXY($current_x+2, $current_y+9.5);
  $pdf->Cell(7,7,'JT:',0,0,'L',False);
  $pdf->Cell(33,6,$jt,'B',0,'L',False);
  $pdf->SetXY($current_x, $current_y+14.1);
  $pdf->Ln(10.8);
  ...
  $pdf->SetXY($current_x, $current_y);
  $pdf->Ln(2.5);
  $pdf->MultiCell(23.755,10,'GRUPO ALIMENTO',0,'C',False);
  ...
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(50,4,'CNT DE ALIMENTOS POR',0,4,'C',False);
  $pdf->Cell(50,4,utf8_decode('NÚMEROS DE RACIONES'),0,4,'C',False);
  $current_y2 = $pdf->GetY();
  $current_x2 = $pdf->GetX();
  ...
  $pdf->Cell(10,3.5,utf8_decode($etario_1),0,3.5,'C',False);
  $pdf->Cell(10,3.5,utf8_decode('AÑOS'),0,3.5,'C',False);

  $pdf->SetXY($current_x2+10, $current_y2);
  $current_y2 = $pdf->GetY();
  $current_x2 = $pdf->GetX();
  $pdf->Cell(10,7,utf8_decode(''),1,0,'C',False);
  $pdf->SetXY($current_x2, $current_y2);
  $pdf->Cell(10,3.5,utf8_decode($etario_2),0,3.5,'C',False);
  $pdf->Cell(10,3.5,utf8_decode('AÑOS'),0,3.5,'C',False);
  ...
  $pdf->Cell(10,7,utf8_decode(''),1,0,'C',False);
  $pdf->SetXY($current_x2, $current_y2);
  $pdf->Cell(10,3.5,utf8_decode($etario_3),0,3.5,'C',False);
  $pdf->Cell(10,3.5,utf8_decode('AÑOS'),0,3.5,'C',False);
  ...
  $pdf->Cell(10,7,utf8_decode(''),1,0,'C',False);
  $pdf->SetXY($current_x2, $current_y2);
  $pdf->Cell(10,3.5,utf8_decode($etario_4),0,3.5,'C',False);
  $pdf->Cell(10,3.5,utf8_decode('AÑOS'),0,3.5,'C',False);
  ...
  $pdf->Cell(10,7,utf8_decode(''),1,0,'C',False);
  $pdf->SetXY($current_x2, $current_y2);
  $pdf->Cell(10,3.5,utf8_decode($etario_5),0,3.5,'C',False);
  $pdf->Cell(10,3.5,utf8_decode('AÑOS'),0,3.5,'C',False);
  ...
  $current_y = $pdf->GetY();
  $current_x = $pdf->GetX();
  $pdf->Cell(28.191,15,'',1,0,'L',False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(32.191,8,utf8_decode('FALTANTES'),'B',8,'C',False);
  $pdf->Cell(9.349,7,'SI','R',0,'C',False);
  $pdf->Cell(8.819,7,'NO','R',0,'C',False);
  $pdf->Cell(10.023,7,'CANT','R',0,'C',False);

  $pdf->SetXY($current_x+28.191, $current_y);
  $current_y = $pdf->GetY();
  $current_x = $pdf->GetX();
  $pdf->Cell(27,15,'',1,0,'L',False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(27,8,utf8_decode('DEVOLUCIÓN'),'B',8,'C',False);
  $pdf->Cell(9,7,'SI','R',0,'C',False);
  $pdf->Cell(9,7,'NO','R',0,'C',False);
  $pdf->Cell(9,7,'CANT','R',0,'C',False);
