...
if ($cantGruposEtarios == 3) {
  ...
  $pdf->MultiCell(45, 2.7, $auxDias, 0, 'C', False);
...
// manejo encabezado con cinco grupos etarios 
if ($cantGruposEtarios == 5) {
  ...
  $pdf->SetXY($current_x, $current_y+2.35);
  $pdf->MultiCell(57.8, 4.7, 'SEMANA: '.$ciclo, 0, 'C', False);
  $pdf->SetXY($current_x, $current_y+9.04);
  ...
  $jm = '';
  $jt = '';
  $totalBeneficiarios = $sedeGrupo1 + $sedeGrupo2 + $sedeGrupo3 + $sedeGrupo4 + $sedeGrupo5;
  ...
  $pdf->Cell(7, 4.7, 'JM:', 0, 0, 'L', False);
  $pdf->Cell(33, 4.7, $jm, 'B', 0, 'L', False);
  $pdf->SetXY($current_x+2, $current_y+11.75);
  $pdf->Cell(7, 4.7, 'JT:', 0, 0, 'L', False);
  $pdf->Cell(33, 4.7, $jt, 'B', 0, 'L', False);
  ...
  $pdf->MultiCell(23.755, 5, 'GRUPO ALIMENTO', 0, 'C', False);
  $pdf->SetXY($current_x+23.788, $current_y);
  $pdf->Cell(48.9, 15, 'ALIMENTO', 1, 0, 'C', False);

  $current_y = $pdf->GetY();
  $current_x = $pdf->GetX();
  $pdf->Cell(65, 15, '', 1, 0, 'L', False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(65, 8, '', 1, 0, 'L', False);
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(65, 4, 'CNT DE ALIMENTOS POR', 0, 4, 'C', False);
  $pdf->Cell(65, 4, utf8_decode('NÚMEROS DE RACIONES'), 0, 4, 'C', False);
  $current_y2 = $pdf->GetY();
  $current_x2 = $pdf->GetX();
  ...
  $pdf->Cell(13, 3.5, utf8_decode($etario_1), 0, 3.5, 'C', False);
  ...
  $pdf->Cell(13, 3.5, utf8_decode($etario_2), 0, 3.5, 'C', False);
  $pdf->Cell(13, 3.5, utf8_decode('AÑOS'), 0, 3.5, 'C', False);
  $pdf->SetXY($current_x2+13, $current_y2);
  $current_y2 = $pdf->GetY();
  $current_x2 = $pdf->GetX();
  ...
  $pdf->Cell(13, 3.5, utf8_decode($etario_3), 0, 3.5, 'C', False);
  $pdf->Cell(13, 3.5, utf8_decode('AÑOS'), 0, 3.5, 'C', False);
  $pdf->SetXY($current_x2+13, $current_y2);
  $current_y2 = $pdf->GetY();
  $current_x2 = $pdf->GetX();
  ...
  $pdf->SetXY($current_x, $current_y);
  $pdf->Cell(0, 8, utf8_decode('DEVOLUCIÓN'), 'B', 8, 'C', False);
  $pdf->Cell(8, 7, 'SI', 'R', 0, 'C', False);
  $pdf->Cell(8, 7, 'NO', 'R', 0, 'C', False);
