<?php
  ...
  $pdf->SetXY($current_x, $current_y);
  if ($Rpc == 'si') {
    $pdf->Cell(88,4,utf8_decode("COORDINADOR ZONAL"),0,0,"C",False);
  }
  else if ($Rpc == 'no') {
  ...
  if ($Rpc == 'si') {
    $pdf->Cell(88,4,utf8_decode('INTERVENTORIA UT INTERSANTANDER 2021'),0,0,'C',False);
  }
  else if ($Rpc == 'no') {
  ...
  // nombres
  if ($Rpc == 'si') {
    $pdf->Cell(88,12,'NOMBRE COORDINADOR ZONAL:',0,0,'L',False);
  }
  else if ($Rpc == 'no') {
  ...
  if ($Rpc == 'si') {
    $pdf->Cell(88,12,'NOMBRE RESPONSABLE:',0,0,'L',False);
  }
  else if ($Rpc == 'no') {
