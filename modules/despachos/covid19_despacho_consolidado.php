...
$pdf->Ln(18);
for ($i=1; $i <= 20 ; $i++) { 
	$pdf->Cell(4,$altoFila,utf8_decode($i),'BL',0,'C',False);
	$pdf->Cell(34,$altoFila,utf8_decode(""),'BL',0,'C',False);
	$pdf->Cell(17,$altoFila,utf8_decode(""),'BL',0,'C',False);
	$pdf->Cell(17,$altoFila,utf8_decode(""),'BL',0,'C',False);
	$pdf->Cell(3.25,$altoFila,utf8_decode(""),'BL',0,'C',False);
	$pdf->Cell(3.25,$altoFila,utf8_decode(""),'BL',0,'C',False);
	$pdf->Cell(3.25,$altoFila,utf8_decode(""),'BL',0,'C',False);
	$pdf->Cell(3.25,$altoFila,utf8_decode(""),'BL',0,'C',False);
	$pdf->Cell(8.5,$altoFila,utf8_decode(""),'BL',0,'C',False);
	$pdf->Cell(8.5,$altoFila,utf8_decode(""),'BL',0,'C',False);
	$pdf->Cell(8.5,$altoFila,utf8_decode(""),'BL',0,'C',False);
	$pdf->Cell(8.5,$altoFila,utf8_decode(""),'BL',0,'C',False);
	$pdf->Cell(8.5,$altoFila,utf8_decode(""),'BL',0,'C',False);
...
$pdf->Cell(0,2,utf8_decode(""),'BLR',0,'C',False);
$pdf->Ln(2);
...
$pdf->Cell(0,4,utf8_decode("Impreso por: InfoPAE - www.infopae.com.co"),0,0,'L',False);
  ...
  foreach ($grupos_alimentarios as $nombre_grupo => $grupo_alimentario)
  {
	...
	foreach ($grupo_alimentario as $alimento)
	{
	  ...
	  //var_dump($largoNombreProducto);
	  $largoNombreProducto =37;
