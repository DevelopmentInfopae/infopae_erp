...
if ($cantGruposEtarios == 5) {
	...
	$current_y = $pdf->GetY();
	$current_x = $pdf->GetX();
	$pdf->Cell(34,5,utf8_decode('N° DE RACIONES ATENDIDAS'),'TLB',0,'C',true);
	$pdf->SetXY($current_x+34, $current_y);
	...
	$aux_x_despues = $pdf->GetX();
	$pdf->SetXY($aux_x_antes, $aux_y_antes+0.5);
	$pdf->MultiCell(26,6.5,utf8_decode($auxDias),0,'C',False);
	$pdf->SetXY($aux_x_despues, $aux_y_despues);
	...
	$pdf->Cell(35,4.3,utf8_decode($sedeGrupo1),'B',5,'C',False);
	$pdf->Cell(35,4.3,utf8_decode($sedeGrupo2),'B',5,'C',False);
	$pdf->Cell(35,4.3,utf8_decode($sedeGrupo3),'B',5,'C',False);
	$pdf->Cell(35,4.3,utf8_decode($sedeGrupo4),'B',5,'C',False);
	$pdf->Cell(35,4.3,utf8_decode($sedeGrupo5),0,0,'C',False);
	...
	$pdf->Cell(10, 10, utf8_decode(''), 'LTB', 0, 'C',true);
	$pdf->Cell(11.3,10,utf8_decode(''),'LTB',0,'C',true);
	$pdf->Cell(22, 10, utf8_decode(''), 'LTB', 0, 'C', true);
	$pdf->Cell(17,10,utf8_decode(''),'LTB',0,'C',true);
	...
	$pdf->MultiCell(11.3,2,utf8_decode('CANTIDAD TOTAL'),0,'C',false);
