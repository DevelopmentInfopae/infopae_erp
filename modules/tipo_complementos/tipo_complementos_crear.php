...
<div class="row wrapper wrapper-content border-bottom white-bg page-heading">
  ...
  <div class="col-lg-4">
    <div class="title-action">
      <a href="#" class="btn btn-primary" id="guardarTipoComplemento"><i class="fa fa-check "></i> Guardar </a>
    </div>
  </div>
</div>
    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-content contentBackground">
          <form id="formCrearTipoComplemento">
          	<div class="row">
        			<div class="col-sm-12">
                ...
                <div class="form-group col-sm-6 col-md-2">
                  ...
                  <input type="text" class="form-control" name="codigo" id="codigo" maxlength="10" required>
	                ...
	                <input type="text" class="form-control" name="descripcion" id="descripcion" maxlength="200">
	              </div>
                  ...
                  <select class="form-control" name="jornada" id="jornada">
                    ...
                    if($resultado->num_rows > 0)
                    {
                      ...
                      {
                    ?>
                    <option value="<?php echo $registros['codigoJornada']; ?>"><?php echo $registros['nombreJornada']; ?></option>
                    <?php
                      }
                    }
                    ?>
          		...
          		<div class="col-sm-12">
          			<div class="row-">
          				<div class="col-sm-3 col-lg-2 text-center">
      							<a href="#" class="btn btn-primary" id="guardarTipoComplementoContinuar"><i class="fa fa-check "></i> Guardar y continuar </a>
          				</div>
          			</div>
          		</div>
          	</div>
