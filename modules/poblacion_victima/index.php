<?php
  ...
  <?php exit(); }
        ...
        ?><script type="text/javascript">
          ...
          const list2 = document.querySelector(".li_poblacionVictima");
          list2.className += " active ";
        </script>
        <?php
        }

  $titulo = 'Población victima';
  $nameLabel = get_titles('configuracion', 'poblacionVictima', $labels);
  $titulo = $nameLabel;
?>
      ...
      <div class="ibox float-e-margins">
        <div class="ibox-content contentBackground">
          <table id="box-table" class="table table-striped table-hover selectableRows">
            ...
            <tbody>
              <?php
                $consulta = "SELECT * FROM pobvictima";
...
<script>
  ...
  $('#box-table').DataTable({
    buttons: [ {extend: 'excel', title: 'Población_victima', className: 'btnExportarExcel', exportOptions: { columns: [ 0, 1] } } ],
