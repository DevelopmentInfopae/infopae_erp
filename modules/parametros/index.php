...
<style type="text/css">
	#assistance_format-container--open {
      z-index: 9999999
  }
</style>
                      						...
                      						<?php
                        						...
                        						if($result1->num_rows > 0){
                          							while($row1 = $result1->fetch_assoc()){ ?>
                            							...
                            							<?php if(isset($datos['CodDepartamento']) && $datos['CodDepartamento'] == $row1['id']){ echo ' selected '; } ?>><?php echo $row1['nombre']; ?></option><?php
                          							}
                        						}
                      						?>
                    					</select>
...
<script src="<?php echo $baseUrl; ?>/theme/js/plugins/bootstrap-select/bootstrap-select.min.js"></script>
