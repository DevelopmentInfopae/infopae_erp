	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-8">
			...
			<ol class="breadcrumb">
				...
				<?php if(!isset($_POST['sede'])){ ?> <li> <a href="titulares.php?semana=<?php echo $semana; ?>">Titulares</a> </li> <?php } else{ ?>
			...
			<div class="ibox float-e-margins">
				...
				<div>
					...
					<div class="ibox-content profile-content">
						...
						<br> <?php echo $_POST['tipoDoc'];  ?> # <?php echo $_POST['numDoc'];  ?> </p>
			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<div>
						...
						//Buscar el mes hasta el que existen entreagas res
						for ($i=1; $i <= 12 ; $i++) {
							if($i < 10){
								$aux = '0'.$i;
							}else{
							...
							$consulta = " show tables like 'entregas_res_$aux$periodoActual' ";
							$resultado = $Link->query($consulta) or die ('Unable to execute query. '. mysqli_error($Link));
							if($resultado->num_rows >= 1){
								$ultimoMes = $i;
							}else{
