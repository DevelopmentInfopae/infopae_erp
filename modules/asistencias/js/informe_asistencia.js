...
function cargarEstudiantes(){
	...
	ajax: {
		method: 'POST',
		url: 'functions/fn_informe_asistencia.php',
		data:{
			dia: dia,
	...
	columns:[
		{
			...
			"render": function ( data, type, full, meta ) {
				...
				if(asistencia == 1){opciones = "Si"; }else{opciones = "No"; }
				return opciones;
			}
		},	
		{ data: 'num_doc'},
		...
		{ data: 'grupo',className: "text-center"},
		{
			...
			"render": function ( data, type, full, meta ) {		
				...
				if(consumio == 1){opciones = "Si"; }else{opciones = "No"; }
				return opciones;	
			}
		},				
		{
			...
			"render": function ( data, type, full, meta ) {
				...
				if(repitio == 1){opciones = "Si"; }else{opciones = "No"; }
				return opciones;
			}
		}
	],
