<?php 
$consultaMes = " SELECT DISTINCT(MES_ENTREGAS) AS mes FROM planilla_semanas ";
						...
						<div class="col-sm-12">
							<form action="" id="form_asistencia" name="form_asistencia" method="post">
								...
								<div class="form-group row">
									<div class="col-sm-12">
										<button class="btn btn-primary" type="button" id="btnBuscar"><strong> <i class="fa fa-search"></i> Buscar </strong> </button>
									</div>
								</div>
							</form>
						</div>
