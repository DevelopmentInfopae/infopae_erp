...
if ($resultadoInfraestructura->num_rows > 0) {
  if ($DatosInfraestructura = $resultadoInfraestructura->fetch_assoc()) {
    ...
    if (!isset($idinfraestructura)) {
      $idinfraestructura = $DatosInfraestructura['id'];
    }
  }
}
      ...
      <div class="panel-body">
        <form class="form row" id="formInfraestructura">
          ...
          <div class="form-group col-sm-3">
            ...
            <input type="text" class="form-control" name="id_Complem_JMJT" value="<?php echo $modalidades[$Infraestructura[0]['id_Complem_JMJT']] ?>" readonly>
          </div>
          <div class="form-group col-sm-3">
            <label>Almuerzo</label>
            <input type="text" class="form-control" name="id_Almuerzo" value="<?php echo $modalidades[$Infraestructura[0]['id_Almuerzo']] ?>" readonly>
          </div>
          <div class="form-group col-sm-3">
            <label>Concepto sanitario</label>
            <input type="text" class="form-control" name="Concepto_Sanitario" value="<?php echo $conceptos_sanitario[$Infraestructura[0]['Concepto_Sanitario']] ?>" readonly>
          </div>
          <div class="form-group col-sm-3">
            <label>Fecha de expedición</label>
            <input type="date" class="form-control" name="fecha_expedicion" value="<?php echo $Infraestructura[0]['Fecha_Expe'] ?>" readonly>
          </div>
          <div class="form-group col-sm-3">
...
if ($resultadoParametrosInfraestructura->num_rows > 0) {
  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="heading_<?php echo $cntParametro ?>">
      <h4 class="panel-title">
        <a class="collapsed pull-right" role="button" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cntParametro ?>" aria-expanded="false" aria-controls="<?php echo $cntParametro ?>" id="btnEditar_<?php echo $cntParametro ?>" style="color: #337ab7;"> Ver
        </a>
