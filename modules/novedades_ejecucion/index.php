                  ...
                  <div class="row">
                     <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                           ...
                           <select class="form-control select2" name="municipio" id="municipio" required="required" style="width: 100%;">
                              <option value="">seleccione</option>
                              <?php
                                 $parametro_municipio = (! empty($codigo_municipio)) ? "AND CodigoDANE = '$codigo_municipio'" : "";
                                 $consulta_municipios = "SELECT   CodigoDANE AS codigo, 
                                                                  Ciudad AS nombre 
                                                               FROM ubicacion 
                                                               WHERE CodigoDANE LIKE '$codigo_departamento%' $parametro_municipio 
                                                               ORDER BY Ciudad ASC ";
                     ...
                     <div class="col-md-4 col-sm-12 form-group">
                        ...
                        <select class="form-control select2" name="institucion" id="institucion" required="required" style="width: 100%;">
                           <option value="">seleccione</option>
                           <?php
                              $consulta_instituciones = " SELECT  codigo_inst AS codigo, 
                                                                  nom_inst AS nombre 
                                                               FROM instituciones 
                                                               WHERE cod_mun = '". $codigo_municipio ."' 
                                                               ORDER BY nom_inst ";
                     ...
                     <div class="col-md-4 col-sm-12 form-group">
                        ...
                        <select class="form-control select2" name="sede" id="sede" required="required" style="width: 100%;">
                           <option value="">seleccione</option>
                        </select>
                  ...
                  <div class="row">
                     <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                           ...
                           <select class="form-control select2" name="mes" id="mes" required="required" style="width: 100%;">
                              <option value="">seleccione</option>
                           </select>
                     ...
                     <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                           ...
                           <select class="form-control select2" name="semana" id="semana" required="required" style="width: 100%;">
                              <option value="">seleccione</option>
                           </select>
                     ...
                     <div class="col-md-4 col-sm-12 form-group">
                        ...
                        <select class="form-control select2" name="tipo_complemento" id="tipo_complemento" required="required" style="width: 100%;">
                           <option value="">seleccione</option>
                        </select>
