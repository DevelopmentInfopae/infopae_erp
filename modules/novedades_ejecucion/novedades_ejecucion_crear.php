				...
				<form class="col-lg-12" action="" method="post" name="formulario_buscar_focalizacion" id="formulario_buscar_focalizacion" enctype="multipart/form-data">
		         <div class="row">
		            <div class="col-md-4 col-sm-12 form-group">
		              	...
		              	<select class="form-control" name="municipio" id="municipio" required style="width: 100%;">
		                	<option value="">seleccione</option>
		                	<?php
		                		$codigo_departamento = $_SESSION['p_CodDepartamento'];
		                		$consulta_municipio = "	SELECT 	u.Ciudad, 
		                													u.CodigoDANE 
		                											FROM ubicacion u 
		                											WHERE u.ETC = 0 AND CodigoDANE LIKE '$codigo_departamento%' 
		            ...
		            <div class="col-md-4 col-sm-12 form-group">
		              	...
		              	<select class="form-control" name="institucion" id="institucion" required style="width: 100%;">
		                	<option value="">seleccione</option>
		                	<?php
		                		$parametro_municipio = (isset($_SESSION["p_Municipio"]) && $_SESSION["p_Municipio"] > 0) ? " AND cod_mun = '". $_SESSION['p_Municipio'] ."'" : "";
	                			$consulta = "	SELECT 	i.codigo_inst, 
	                											i.nom_inst 
	                										FROM instituciones i 
	                										WHERE 1 = 1 $parametro_municipio 
	                										ORDER BY i.nom_inst";
		            ...
		            <div class="col-md-4 col-sm-12 form-group">
		            	...
		            	<select class="form-control" name="rango" id="rango" required style="width:100%;">
		            		<option value="">seleccione</option>
		            		<option value="0">Días completos</option>
		            		<option value="1">Días parciales</option>
		            	</select>
		            	<label for="rango" class="error" style="display: none;"></label>
		            </div> <!-- col -->

		            <div class="col-md-4 col-sm-12 form-group">
		              	<label for="sede">Sede</label>
		              	<select class="form-control" name="sede" id="sede" required style="width: 100%;">
		                	<option value="">seleccione</option>
		              	</select>
		            ...
		            <div class="col-md-4 col-sm-12 form-group">
		              	...
		              	<select class="form-control" name="mes" id="mes" required style="width: 100%;">
		                	<option value="">seleccione</option>
		              	</select>
		            ...
		            <div class="col-sm-4 col-sm-12 form-group">
		              	...
		              	<select class="form-control" name="semana" id="semana" required style="width: 100%;">
		                	<option value="">seleccione</option>
		              	</select>
		              	<div id="semana"> </div>
		            ...
		            <div class="col-sm-4 col-sm-12 form-group">
		              	...
		              	<select class="form-control" name="tipoComplemento" id="tipoComplemento" required style="width: 100%;">
		                	<option value="">seleccione</option>
		              	</select>
