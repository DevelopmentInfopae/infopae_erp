...
<?php
	...
	$nameLabel = get_titles('novedades', 'focalizacion', $labels);
	$titulo = $nameLabel. " - Nueva";
?>
	
<?php 
	if ($_SESSION['perfil'] == "0" || $permisos['novedades'] == "2"): 
?>
        			...
        			<div class="ibox-content contentBackground">
						<form class="col-lg-12" action="" method="post" name="formulario_buscar_focalizacion" id="formulario_buscar_focalizacion" enctype="multipart/form-data">
	          				<div class="row">
								...
								<div class="col-md-4 col-sm-12 form-group">
	              					<label for="tipoNovedad">Rango de Novedad</label>
	              					...
	              					<label for="tipoNovedad" class="error" style="display: none;"></label>
	            				</div>
