...
$consulta = "DELETE ocd, oce FROM orden_compra_enc$mesi$annoi oce LEFT JOIN orden_compra_det$mesi$annoi ocd ON oce.Num_Doc = ocd.Num_Doc WHERE oce.Num_OCO = $numero";
