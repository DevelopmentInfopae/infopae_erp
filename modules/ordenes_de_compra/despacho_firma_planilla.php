...
$pdf->Cell(0,5,'D: Cumple  ND: No Cumple','LR',5,'L',False);
...
$pdf->ln(22);
$pdf->Cell(0,5,utf8_decode('Impreso por Sistema de Información Tecnológico Infopae Versión 2020'),0,0,'C',False);
$pdf->ln();
