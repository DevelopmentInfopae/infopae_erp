...
// exit(var_dump($gruposEtarios));
	class PDF extends FPDF {
		...
		function Header(){
			...
			$this->setXY($cx+(35*2+40), $cy);
			$this->Cell(28,30,utf8_decode($this->manipuladoras),'TBLR',0,'C');//MANIPULADORAS DE LA SEDE
			$this->Cell(12,30,utf8_decode($this->dias),'TBLR',0,'C'); // numero dias
			$this->Cell(26,30,utf8_decode($this->maxEstudiantes),'TBR',0,'C');//CANTIDAD COBERTURA
			$this->Cell(25.9,30,utf8_decode($this->tipoComplemento),'TBR',0,'C');//CANTIDAD COBERTURA
