<?php
  ...
  <?php exit(); }
        ...
        ?><script type="text/javascript">
          ...
          const list2 = document.querySelector(".li_grados");
  ...
  $titulo = 'Grados';
  $nameLabel = get_titles('configuracion', 'grados', $labels);
  $titulo = $nameLabel;
?>
...
<script>
  ...
  $('#box-table').DataTable({
    buttons: [ {extend: 'excel', title: 'Grados', className: 'btnExportarExcel', exportOptions: { columns: [ 0, 1] } } ],
