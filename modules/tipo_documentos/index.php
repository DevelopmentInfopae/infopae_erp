<?php
  ...
  <?php exit(); }
        ...
        ?><script type="text/javascript">
          ...
          const list2 = document.querySelector(".li_tipoDocumentos");
  ...
  $nameLabel = get_titles('configuracion', 'tipoDocumentos', $labels);
  $titulo = $nameLabel;
?>
          ...
          <table id="box-table" class="table table-striped table-hover selectableRows">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td align="left"><?php echo $registros['Abreviatura']; ?></td>
              </tr>
              <?php
                  }
                }
...
<script>
  ...
  $('#box-table').DataTable({
    buttons: [ {extend: 'excel', title: 'Tipo_documentos', className: 'btnExportarExcel', exportOptions: { columns: [ 0, 1] } } ],
