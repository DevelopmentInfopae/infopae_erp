...
<div class="modal inmodal fade" id="modal_crear_parametros_infraestructura" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-sm" role="document">
		<form action="" method="post" id="formCrearParametrosInfraestructura">
			<div class="modal-content">
		      	...
		      	<div class="modal-footer">
		        	...
		        	<button type="button" class="btn btn-primary" id="guardar_parametros_infraestructura"><i class="fa fa-check"></i> Guardar</button>
		      	</div> <!-- modal-footer -->
			</div> <!-- modal-content -->
		</form> <!-- form -->
	</div> <!-- modal-dialog -->
...
<script type="text/javascript">
	$(document).ready(function() {	
		$('#modal_crear_parametros_infraestructura').modal('show');
	});
