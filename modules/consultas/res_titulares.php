      ...
      <table width="100%" id="box-table-d" class="table table-striped table-bordered table-hover">
        <thead>
          <tr>
            ...
            <th>Sede</th>
            <?php if ($mes == date("m")) { ?>
              <?php if($rowDias['D1'] >= 1 && $rowDias['D1'] <= date("d")){ ?> <th> <?php echo $rowDias['D1']; ?> </th> <?php } ?>
              <?php if($rowDias['D2'] >= 1 && $rowDias['D2'] <= date("d")){ ?> <th> <?php echo $rowDias['D2']; ?> </th> <?php } ?>
              <?php if($rowDias['D3'] >= 1 && $rowDias['D3'] <= date("d")){ ?> <th> <?php echo $rowDias['D3']; ?> </th> <?php } ?>
              <?php if($rowDias['D4'] >= 1 && $rowDias['D4'] <= date("d")){ ?> <th> <?php echo $rowDias['D4']; ?> </th> <?php } ?>
              <?php if($rowDias['D5'] >= 1 && $rowDias['D5'] <= date("d")){ ?> <th> <?php echo $rowDias['D5']; ?> </th> <?php } ?>
              <?php if($rowDias['D6'] >= 1 && $rowDias['D6'] <= date("d")){ ?> <th> <?php echo $rowDias['D6']; ?> </th> <?php } ?>
              <?php if($rowDias['D7'] >= 1 && $rowDias['D7'] <= date("d")){ ?> <th> <?php echo $rowDias['D7']; ?> </th> <?php } ?>
              <?php if($rowDias['D8'] >= 1 && $rowDias['D8'] <= date("d")){ ?> <th> <?php echo $rowDias['D8']; ?> </th> <?php } ?>
              <?php if($rowDias['D9'] >= 1 && $rowDias['D9'] <= date("d")){ ?> <th> <?php echo $rowDias['D9']; ?> </th> <?php } ?>
              <?php if($rowDias['D10'] >= 1  && $rowDias['D10'] <= date("d")){ ?> <th> <?php echo $rowDias['D10']; ?> </th> <?php } ?>
              <?php if($rowDias['D11'] >= 1  && $rowDias['D11'] <= date("d")){ ?> <th> <?php echo $rowDias['D11']; ?> </th> <?php } ?>
              <?php if($rowDias['D12'] >= 1  && $rowDias['D12'] <= date("d")){ ?> <th> <?php echo $rowDias['D12']; ?> </th> <?php } ?>
              <?php if($rowDias['D13'] >= 1  && $rowDias['D13'] <= date("d")){ ?> <th> <?php echo $rowDias['D13']; ?> </th> <?php } ?>
              <?php if($rowDias['D14'] >= 1  && $rowDias['D14'] <= date("d")){ ?> <th> <?php echo $rowDias['D14']; ?> </th> <?php } ?>
              <?php if($rowDias['D15'] >= 1  && $rowDias['D15'] <= date("d")){ ?> <th> <?php echo $rowDias['D15']; ?> </th> <?php } ?>
              <?php if($rowDias['D16'] >= 1  && $rowDias['D16'] <= date("d")){ ?> <th> <?php echo $rowDias['D16']; ?> </th> <?php } ?>
              <?php if($rowDias['D17'] >= 1  && $rowDias['D17'] <= date("d")){ ?> <th> <?php echo $rowDias['D17']; ?> </th> <?php } ?>
              <?php if($rowDias['D18'] >= 1  && $rowDias['D18'] <= date("d")){ ?> <th> <?php echo $rowDias['D18']; ?> </th> <?php } ?>
              <?php if($rowDias['D19'] >= 1  && $rowDias['D19'] <= date("d")){ ?> <th> <?php echo $rowDias['D19']; ?> </th> <?php } ?>
              <?php if($rowDias['D20'] >= 1  && $rowDias['D20'] <= date("d")){ ?> <th> <?php echo $rowDias['D20']; ?> </th> <?php } ?>
              <?php if($rowDias['D21'] >= 1  && $rowDias['D21'] <= date("d")){ ?> <th> <?php echo $rowDias['D21']; ?> </th> <?php } ?>
              <?php if($rowDias['D22'] >= 1  && $rowDias['D22'] <= date("d")){ ?> <th> <?php echo $rowDias['D22']; ?> </th> <?php } ?>
            <?php } else {?>
        ...
        ?>
          <tr>
            ...
            <?php if ($mes == date("m")) { ?>
              <?php if($rowDias['D1']  >= 1 && $rowDias["D1"] <= date("d")) { ?> <td align="center"> <?php if($row['D1'] == '1') { $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D2']  >= 1 && $rowDias["D2"] <= date("d")) { ?> <td align="center"> <?php if($row['D2'] == '1') { $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D3']  >= 1 && $rowDias["D3"] <= date("d")) { ?> <td align="center"> <?php if($row['D3'] == '1') { $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D4']  >= 1 && $rowDias["D4"] <= date("d")) { ?> <td align="center"> <?php if($row['D4'] == '1') { $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D5']  >= 1 && $rowDias["D5"] <= date("d")) { ?> <td align="center"> <?php if($row['D5'] == '1') { $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D6']  >= 1 && $rowDias["D6"] <= date("d")) { ?> <td align="center"> <?php if($row['D6'] == '1') { $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D7']  >= 1 && $rowDias["D7"] <= date("d")) { ?> <td align="center"> <?php if($row['D7'] == '1') { $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D8']  >= 1 && $rowDias["D8"] <= date("d")) { ?> <td align="center"> <?php if($row['D8'] == '1') { $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D9']  >= 1 && $rowDias["D9"] <= date("d")) { ?> <td align="center"> <?php if($row['D9'] == '1') { $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D10'] >= 1 && $rowDias["D10"] <= date("d")) { ?> <td align="center"> <?php if($row['D10'] == '1'){ $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D11'] >= 1 && $rowDias["D11"] <= date("d")) { ?> <td align="center"> <?php if($row['D11'] == '1'){ $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D12'] >= 1 && $rowDias["D12"] <= date("d")) { ?> <td align="center"> <?php if($row['D12'] == '1'){ $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D13'] >= 1 && $rowDias["D13"] <= date("d")) { ?> <td align="center"> <?php if($row['D13'] == '1'){ $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D14'] >= 1 && $rowDias["D14"] <= date("d")) { ?> <td align="center"> <?php if($row['D14'] == '1'){ $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D15'] >= 1 && $rowDias["D15"] <= date("d")) { ?> <td align="center"> <?php if($row['D15'] == '1'){ $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D16'] >= 1 && $rowDias["D16"] <= date("d")) { ?> <td align="center"> <?php if($row['D16'] == '1'){ $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D17'] >= 1 && $rowDias["D17"] <= date("d")) { ?> <td align="center"> <?php if($row['D17'] == '1'){ $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D18'] >= 1 && $rowDias["D18"] <= date("d")) { ?> <td align="center"> <?php if($row['D18'] == '1'){ $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D19'] >= 1 && $rowDias["D19"] <= date("d")) { ?> <td align="center"> <?php if($row['D19'] == '1'){ $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D20'] >= 1 && $rowDias["D20"] <= date("d")) { ?> <td align="center"> <?php if($row['D20'] == '1'){ $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D21'] >= 1 && $rowDias["D21"] <= date("d")) { ?> <td align="center"> <?php if($row['D21'] == '1'){ $total++; echo 'X'; } ?></td><?php } ?>
              <?php if($rowDias['D22'] >= 1 && $rowDias["D22"] <= date("d")) { ?> <td align="center"> <?php if($row['D22'] == '1'){ $total++; echo 'X'; } ?></td><?php } ?>
            <?php } else {?>
