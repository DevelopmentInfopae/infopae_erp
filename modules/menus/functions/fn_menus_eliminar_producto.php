					...
					if ($resultadoMenu->num_rows > 0) {
						...
						if (verificarDespachoMenu($tipoComplemento, $ordenCiclo)) {
							...
							if (substr($codigoProducto, 0, 2) == "04") {
								$consultarAlimentoIndus = "SELECT productos".$_SESSION['periodoActual'].".id, fichatecnicadet.codigo FROM fichatecnicadet, productos".$_SESSION['periodoActual']." WHERE fichatecnicadet.IdFT = ".$IdFTPreparado." AND productos".$_SESSION['periodoActual'].".codigo = fichatecnicadet.codigo";
