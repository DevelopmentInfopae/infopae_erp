...
?>	<script type="text/javascript">
		...
		const list2 = document.querySelector(".li_tipoAlimentos");
            			...
            			<div class="row">
              				<div class="col-sm-8">
								...
								<div class="form-group col-sm-4 col-md-4">
									...
									<select name="redondeo" id="redondeo" class="form-control" required>
            			...
            			<tbody>
              				...
              				?>
              						<tr>
                						...
                						<?php
                  							$icon = '';
                  							if ($registros['Redondeo'] == 0) {
                    							$icon = "<i class='fas fa-circle'></i>";
                  							}
                  							if ($registros['Redondeo'] == 1) {
                  							...
                  							<div class="btn-group">
                    							<div class="dropdown">
                      								...
                      								<ul class="dropdown-menu pull-right" aria-labelledby="dLabel">
                        								<li><a 	href="#" 
																class="editarTipoDespacho" 
																data-codigotipodespacho="<?php echo $registros['Id']; ?>" 
																data-descripciontipodespacho="<?php echo $registros['Descripcion']; ?>"
																data-redondeo="<?php echo $registros['Redondeo']; ?>">
																<i class="fa fa-pencil-alt fa-lg"></i> Editar
															</a>
														</li>
