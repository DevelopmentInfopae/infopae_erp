...
<div class="modal fade in" id="modal_crear_tipo_persona_fqrs" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<form action="" method="post" id="formCrearTipoPersonaFqrs">
			<div class="modal-content">
				<div class="modal-header">
		        	<h4 class="modal-title">Creación Tipo Persona FQRS</h4>
		      	</div>
...
<script type="text/javascript">
	$(document).ready(function() {	
		$('#modal_crear_tipo_persona_fqrs').modal('show');
	});
