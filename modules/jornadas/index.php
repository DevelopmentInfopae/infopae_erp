<?php
  ...
  ?><script type="text/javascript">
    ...
    const list2 = document.querySelector(".li_jornadas");
  ...
  $titulo = 'Jornadas';
  $nameLabel = get_titles('configuracion', 'jornadas', $labels);
  $titulo = $nameLabel;
?>
...
<script>
  ...
  $('#box-table').DataTable({
    buttons: [ {extend: 'excel', title: 'Jornadas', className: 'btnExportarExcel', exportOptions: { columns: [ 0, 1] } } ],
