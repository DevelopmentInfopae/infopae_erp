...
function actualizarUsuario(){
  ...
  if($('#formActualizarUsuario').valid()){
    ...
    // var estado = (typeof $('#estado').val() === 'undefined')? "" : $('#estado').val();
		...
		if( $("#nuevaContrasenna1").val() != '' || $("#nuevaContrasenna2").val() != '' || $("#contrasennaActual").val() != '' ){
			if( $("#nuevaContrasenna1").val().length < 8 ){
				bandera++;
			...
			} else if( $("#nuevaContrasenna1").val() != $("#nuevaContrasenna2").val() ){
				bandera++;
				Command: toastr.error(
			...
			if( bandera == 0 ){
				formData.append('nuevaContrasenna1', $("#nuevaContrasenna1").val());
				formData.append('nuevaContrasenna2', $("#nuevaContrasenna2").val());
				formData.append('contrasennaActual', $("#contrasennaActual").val());
			}
		}
		// contrasennaActual
		// nuevaContrasenna1
