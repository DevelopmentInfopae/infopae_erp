  ...
  if($('#formActualizarUsuario').valid()){
    ...
    formData.append('numeroDocumento', $('#numeroDocumento').val());
		...
		if( $("#nuevaContrasenna1").val() != '' || $("#nuevaContrasenna2").val() != '' || $("#contrasennaActual").val() != '' ){
			...
			if( bandera == 0 ){
				formData.append('nuevaContrasenna1', sha1($("#nuevaContrasenna1").val()));
				formData.append('nuevaContrasenna2', sha1($("#nuevaContrasenna2").val()));
				formData.append('contrasennaActual', sha1($("#contrasennaActual").val()));
			}
		}
