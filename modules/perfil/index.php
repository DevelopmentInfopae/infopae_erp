		                ...
		                <select class="form-control" name="municipio" id="municipio" required>
		                  ...
		                  ?>
								...
								<div class="row">
									...
									<div class="form-group col-sm-6 col-md-4">
										<label for="nuevaContrasenna1">Nueva contraseña</label>
										<input type="password" class="form-control" name="nuevaContrasenna1" id="nuevaContrasenna1">
									</div>
									<div class="form-group col-sm-6 col-md-4">
										<label for="nuevaContrasenna1">Confirmar contraseña</label>
										<input type="password" class="form-control" name="nuevaContrasenna2" id="nuevaContrasenna2">
									</div>
									<div class="form-group col-sm-6 col-md-4">
										<label for="nuevaContrasenna1">Contraseña actual</label>
										<input type="password" class="form-control" name="contrasennaActual" id="contrasennaActual">
									</div>
								</div>
        			</div>
          	</div>
...
<!-- Section Scripts -->
<script src="<?php echo $baseUrl; ?>/js/funciones.js"></script>
<script src="<?php echo $baseUrl; ?>/modules/perfil/js/usuarios.js"></script>
