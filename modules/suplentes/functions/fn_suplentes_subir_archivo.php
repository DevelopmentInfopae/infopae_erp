...
while(($registro = fgetcsv($archivo_suplentes, null, $separador_registros)) == TRUE)
{
	...
	$primer_apellido = $registro[3];
	$segundo_apellido = $registro[4];
	$primer_nombre = $registro[5];
	$segundo_nombre = $registro[6];
	$genero = $registro[7];
	...
	$nombre_sede = $registro[25];
	$nombre_institucion = $registro[26];
	$grado = $registro[27];
	$grupo = $registro[28];
	$jornada = $registro[29];
	$estado = $registro[30];
