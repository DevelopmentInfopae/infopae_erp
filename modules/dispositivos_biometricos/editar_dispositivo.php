  ...
  <div class="panel panel-default">
    ...
    <div id="datosBiometria" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
      <div class="panel-body">
        <form class="form" id="formFocalizacion">
          <div class="row">
            <div class="form-group col-lg-3 col-md-6 col-sm-12">
              ...
              <select class="form-control" name="cod_municipio" id="cod_municipio" required readonly>
                <option value="">Seleccione...</option>
                <?php 
        ...
        <div class="col-sm-12">
          <button class="btn btn-success" id="buscar1" onclick="buscarEstudiantes();"><span class="fa fa-search"></span>  Buscar estudiantes</button>
        </div>
        ...
        <div class="col-sm-12">
          <button class="btn btn-primary" id="guardar1" onclick="submitFormEditar();"><span class="fa fa-check"></span>  Guardar</button>
        </div>
      </div>
    </div>
  </div>
