      ...
      <div class="panel-body">
        ...
        <input type="hidden" name="iddispositivo" id="iddispositivo" value="<?php echo $iddispositivo; ?>">
          <div class="form-group col-sm-3">
            ...
            <select class="form-control" name="cod_municipio" id="cod_municipio" onchange="existenBiometrias()" required>
          ...
          <div class="form-group col-sm-3">
            ...
            <input type="number" name="num_serial" id="num_serial" class="form-control" value="<?php echo $infoDispositivo['num_serial'] ?>" required>
            ...
            <table class="table" id="tablaEstudiantes">
              ...
              <tbody id="tbodyEstudiantes">
               ...
               foreach ($focalizaciones as $focalizacion => $valor) {
                $selectFoc = " ".$valor.".nom1, ".$valor.".ape1, ".$valor.".cod_grado, ";
                  ...
                  while ($biometria = $resultadoBiometria->fetch_assoc()) { 
                   ...
                   <tr id="biometria_<?php echo $cnt ?>">
                    ...
                    <input type="hidden" name="idBiometria[<?php echo $biometria['num_doc']; ?>]" value="<?php echo $biometria['id']; ?>"></td>
                     ...
                     <td><input type='number' name='id_bioest[<?php echo $biometria['num_doc']; ?>]' id='id_bioest' onchange='validaBioEst(this, "<?php echo $cnt; ?>", 2)' class='form-control' value="<?php echo $biometria['id_bioest']; ?>"><em style='color: #cc5965; font-size: 13px; display: none;' id='existeBioEstEdit<?php echo $cnt; ?>'>Ya digitó un id similar a este.</em></td>
                     <!-- <td><span class="btn btn-danger btn-sm btn-outline"  data-toggle="modal" data-target="#modalEliminarBiometria" data-idbiometria="<?php echo $biometria['id']; ?>" data-numbiometria="<?php echo $cnt; ?>" title='Eliminar registro biométrico'><span class="fa fa-trash"></span></span>
                            </td> -->
                   </tr>
                  <?php
                    } 
