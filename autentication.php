...
if (!isset($_SESSION["autentificado"]) || $_SESSION["autentificado"]!="SI" || ( $_SESSION["perfil"]!=0 && $_SESSION["perfil"]!=1 && $_SESSION["perfil"]!=5 && $_SESSION["perfil"]!=6 && $_SESSION["perfil"]!=8 && $_SESSION["perfil"]!=3 ) ) {
