<li>
  ...
  <ul class="nav nav-second-level collapse">
    <li>
    	<a href="<?php echo $baseUrl; ?>/modules/parametros"><i class="fa fa-clock-o"></i> <span class="nav-label">Parámetros</span></a>
    </li>
    <li>
        <a href="<?php echo $baseUrl; ?>/modules/usuarios"><i class="fa fa-list" aria-hidden="true"></i> <span class="nav-label">Usuarios</span></a>
    </li>
