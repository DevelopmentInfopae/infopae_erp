<?php 
	...
	$idUsuario = $_REQUEST["codigoUsuario"];
...
<div class="row wrapper wrapper-content border-bottom white-bg page-heading">
  <div class="col-lg-8">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">
      	<a href="<?php echo $baseUrl . '/modules/usuarios'; ?>">Usuarios</a>
      </li>
      <li class="active">
    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-content contentBackground">
          <form action="functions/fn_usuarios_actualizar.php" method="post">
          	<div class="row">
          		<div class="col-sm-3 col-lg-2 text-center">
									...
									<div class="fileinput fileinput-new" data-provides="fileinput">
									  ...
									  <div class="text-center">
									    <span class="btn btn-default btn-file" disabled>
									    	...
									    	<input type="file" name="foto" id="foto" accept="image/jpg, image/jpeg, image/png" disabled>
									    </span>
        			...
        			<div class="col-sm-9 col-lg-10">
		                ...
		                <input type="text" class="form-control" name="numeroDocumento" id="numeroDocumento" value="<?php echo $row['num_doc']; ?>" required disabled>
		                <input type="hidden" name="id" id="id" value="<?php echo $idUsuario; ?>">
		              </div>

		              <div class="form-group col-sm-6 col-md-4">
		                <label for="nombre">Nombres y Apellidos</label>
		                <input type="text" class="form-control" name="nombre" id="nombre" value="<?php echo $row['nombre'] ?>" required disabled>
		              </div>

									<div class="form-group col-sm-6 col-md-4">
		                <label for="email">Email</label>
		                <input type="email" class="form-control" name="email" id="email" value="<?php echo $row['email'] ?>" required disabled>
		              </div>
        				</div>
								<div class="row">
									<div class="form-group col-sm-6 col-md-4">
		                <label for="telefono">Teléfono</label>
		                <input type="text" class="form-control" name="telefono" id="telefono" value="<?php echo $row['telefono'] ?>" disabled>
		              </div>
		              <div class="form-group col-sm-6 col-md-4">
		                <label for="direccion">Dirección</label>
		                <input type="text" class="form-control" name="direccion" id="direccion" value="<?php echo $row['direccion'] ?>" disabled>
		              </div>
	              ...
	              <div class="form-group col-sm-6 col-md-4">
	                ...
	                <input type="text" class="form-control" name="tipoUsuario" id="tipoUsuario" value="<?php echo $row['Tipo_Usuario'] ?>" required disabled>
	              </div>
