			...
			while(($datos = fgetcsv($archivoCSV, ","))==true){
				if($fila>0){
				  ...
				  if(!in_array($datos[0], $arrayCodigosInstituciones)){
				  	$consultaCrearInstitucion.="('".$datos[0]."', '".$datos[4]."', '".$datos[3]."', '', '', '0'), ";
				  ...
				  if(!in_array($datos[1], $arrayCodigosSedes)){
				  	$consultaCrearSede.="('".$datos[0]."', '".$datos[1]."', '".$datos[2]."', '".$datos[3]."', '".$datos[4]."', '".$datos[5]."', '".$datos[6]."', '".$datos[7]."', '".$datos[8]."', '".$datos[9]."', '".$datos[10]."', '".$datos[11]."', '".$datos[12]."', ''), ";
