			  ...
			  if ($tipoProducto == "01" && $IdFT != 0) {
			    for ($i=1; $i <= sizeof($productoFichaTecnicaDet); $i++) { 
			      ...
			      if (isset($IdFTDet[$i])) {
			      	...
			      	$sqlFichaTecnicaDet = "insert into fichatecnicadet (Id, codigo, Componente, Cantidad, UnidadMedida, Costo, IdFT, Subtotal, Factor, Estado, Tipo, TipoProducto, PesoBruto, PesoNeto) values (NULL, '".$productoFichaTecnicaDet[$i]."', '".$descProductoFichaTecnicaDet."', '1', 'u', '0', '".$IdFT."', '0', '0', '0', 'Alimento', 'Alimento', '0', '0')";
			      }
