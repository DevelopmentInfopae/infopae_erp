...
<div class="wrapper wrapper-content animated fadeInRight">
  <div class="row">
    ...
    <button onclick="consultarTrazabilidad();" type="button" class="btn btn-primary">Buscar</button>
              </div><!-- /.col -->
            </div><!-- /.row -->
...
<!-- Section Scripts -->
<script src="<?php echo $baseUrl; ?>/modules/menus/js/trazabilidad.js"></script>
