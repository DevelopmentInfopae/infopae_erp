...
if ($Link->query($sqlInfraestructura) === true) {
	...
	if (isset($_POST['utensilios_consumo_suficientes'])) {
		$utensilios_consumo_suficientes = $_POST['utensilios_consumo_suficientes'];
	} else {
		$utensilios_consumo_suficientes = "";
	}
