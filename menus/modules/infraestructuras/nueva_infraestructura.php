...
<div class="row wrapper wrapper-content border-bottom white-bg page-heading">
  ...
  <div class="col-lg-4">
    <div class="title-action">
      <button class="btn btn-primary" onclick="submitForm('');" id="segundoBtnSubmit" style=""><span class="fa fa-check"></span> Guardar</button>
    </div><!-- /.title-action -->
  </div><!-- /.col -->
</div><!-- /.row -->
    ...
    <div id="<?php echo $cntParametro ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_<?php echo $cntParametro ?>">
      <div class="panel-body">
          ...
          <?php endif ?>
              ...
              <?php if ($parametro['id'] == 3): ?>
                ...
                <div class="col-sm-3">
                  ...
                  <div class="radio">
                  <label><input type="radio" name="utensilios_consumo_suficientes[<?php echo $parametro['id'] ?>]" id="utensilios_consumo_suficientes" value="1" required> Si</label>
                  <label><input type="radio" name="utensilios_consumo_suficientes[<?php echo $parametro['id'] ?>]" id="utensilios_consumo_suficientes" value="0" required> No</label>
                  </div>
                  <label for="utensilios_consumo_suficientes[<?php echo $parametro['id'] ?>]" class="error"></label>
                </div>
              <?php endif ?>
        ...
        <div class="col-sm-12">
          ...
          <button class="btn btn-primary" onclick="validForm('form_<?php echo $parametro['id']; ?>', 0, 0);"><span class="fa fa-check"></span>  Guardar</button>
          <?php else: ?>
